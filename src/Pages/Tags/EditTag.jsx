...
const EditTag = () => {
    ...
    const getApiData = async(_id)=>{
        try {
            let res = await axios.get("https://eventserver-rq5v.onrender.com/api/gallery/"+_id)
            console.log(res)
            if (res.status === 200) {
    ...
    const postData = async(e)=>{
        ...
        try {
            setIsloding(true)
            const res =await axios.put("https://eventserver-rq5v.onrender.com/api/gallery/"+_id ,formData)
           if(res.status===200){
